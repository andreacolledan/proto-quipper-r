...
import AST.Bundle (Bundle, BundleType, LabelId, Wide (wireCount), isBundleSubtype)
...
freshTypeVariableName :: StateT TypingEnvironment (Either TypingError) TypeVariableId
